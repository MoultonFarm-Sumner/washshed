  ...
  const processReportData = () => {
    ...
    products.forEach((product: Product) => {
      ...
      productSummary.set(product.id, {
        ...
        added: 0,
        removed: 0,
        current: product.washInventory ? parseFloat(product.washInventory) : product.currentStock,
        isLowStock: (product.washInventory ? parseFloat(product.washInventory) : product.currentStock) < product.minStock,
        isCriticalStock: (product.washInventory ? parseFloat(product.washInventory) : product.currentStock) < (product.minStock / 2),
